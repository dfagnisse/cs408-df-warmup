...
{
    [super viewDidLoad];
    self.placesInfos = [PlacesDatabase database].placesInfos;
    self.title = @"Places";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Set up the cell...
    PlaceInfo *info = [placesInfos objectAtIndex:indexPath.row];
